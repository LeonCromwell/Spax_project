...
import { ReactComponent as DeleteIcon } from "./../../../assets/icon/icon-delete.svg";
import { ReactComponent as EditIcon } from "../../../assets/icon/icon-edit.svg";
import { ReactComponent as MinusIcon } from "../../../assets/icon/icon-minus.svg";
import { ReactComponent as PlusIcon } from "../../../assets/icon/icon-plus.svg";
import { ReactComponent as ReplyIcon } from "../../../assets/icon/icon-reply.svg";
        ...
        <div className="flex flex-col">
          {editing ? (
            ...
            <div className="flex flex-col">
              ...
              />
              <Button
                className="bg-blue-400 text-white w-36 h-12 rounded-lg hover:opacity-50 self-end"
